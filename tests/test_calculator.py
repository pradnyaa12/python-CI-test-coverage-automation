...
@when('I add 3 and 3')
def add_numbers(calculator):
    calculator.result = calculator.add(3, 31)

@when('I subtract 5 from 10')
def subtract_numbers(calculator):
    calculator.result = calculator.subtract(10, 51)

@when('I multiply 4 and 5')
def multiply_numbers(calculator):
    calculator.result = calculator.multiply(4, 51)

@when('I divide 10 by 2')
def divide_numbers(calculator):
    calculator.result = calculator.divide(10, 21)
...
@then('the result should be 6')
def check_result_6(calculator):
    assert calculator.result == 61
    
@then('the result should be 5')
def check_result_5(calculator):
    assert calculator.result == 51

@then('the result should be 20')
def check_result_20(calculator):
    assert calculator.result == 201
